...
function Aboutus() {
  /*useEffect(() => {
    ...
    gsap.from("#about", { opacity: 0, y: 50, duration: 1, ease: "power2.out" });

    // Animation for the spline section
    //gsap.from("#spline", { opacity: 0, y: 50, duration: 1, ease: "power2.out" });
  }, []);*/

  return (
    <div id="parent" className="flex py:10 h-screen overflow-y-hidden">
      <div className="absolute left-10 top-0 w-80 h-80 -mt-60 bg-gradient-to-r from-[#F4C4F3] to-[#FC67FA] filter blur-[150px] rounded-full "></div>
      <div className="absolute left-80 top-0 w-80 h-80 -mt-60 bg-gradient-to-r from-[#1A2980] to-[#26D0CE] filter blur-[150px] rounded-full"></div>
      <div className="absolute left-0 -ml-40 bottom-10 w-40 h-40 bg-white filter blur-[190px]"></div>
      <div className="absolute right-60 top-500 w-40 h-40 bg-gradient-to-r from-[#F4C4F3] to-[#FC67FA] filter blur-[180px] rounded-full "></div>
      <div className="absolute right-40 top-500 w-40 h-40 bg-white filter blur-[200px]"></div>
      <div className="absolute left-56 top-0 w-50 h-80 -mt-60 bg-white filter blur-[90px]"></div>

      

      <div id="about" className="flex-1 mt-[3%] px-20">
      ...
      <div className="content">
        <p className="text-white ml-[10%] mt-5 sm:text-xl max-w-lg text-md">
          the IEEE Robotics and Automation Society (RAS) Student Chapter. Our
      ...
      <div id="spline" className="flex-1">
